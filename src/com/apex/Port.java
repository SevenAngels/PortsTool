...
public class Port implements Serializable {
    ...
    public Port(Region region, int shipSlots, ArrayList<CrewMember> crewRoster, ArrayList<Captain> captains,
                ArrayList<Bow> bows, ArrayList<Hull> hulls, ArrayList<DeckItem> deckItems, ArrayList<Rudder> rudders) {
        this.region = region;
